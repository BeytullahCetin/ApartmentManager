...
<body>
    ...
    $query = "SELECT * FROM users WHERE exitDate IS NULL ORDER BY doorNo";
                                ...
                                <tr>
                                    <?php if ($_SESSION['authorization'] == 1) { ?>
                                        <div class="btn-group">
                                            ...
                                            <td> <a href="userdelete.php?id=<?php echo $user["userID"] ?>" onclick="return confirm('Are you sure?')"><button type="button" class="btn btn-danger">Move-Out</button></a></td>
                                        </div>
                                    <?php } ?>
                    ...
                    <div class="collapse" id="oldresidents">
                        <div class="card-body">
                            <table class="table table-hover table-striped">
                                ...
                                $query = "SELECT * FROM users WHERE exitDate IS NOT NULL ORDER BY doorNo";
                                $result = mysqli_query($conn, $query);
