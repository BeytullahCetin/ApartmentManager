...
<body>
    ...
    <?php
        ...
        echo "<h1 class='login-header'>You don't have admin authorization</h1>";
    }
    ?>
    <a style="text-align: center; display: block; text-decoration: none;" href="logout.php"><button class="btn">Logout</button></a>
    <?php
